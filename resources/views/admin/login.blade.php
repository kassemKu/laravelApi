  ...
  <div id="loginbox">
    <form id="loginform" class="form-vertical" action="{{ url('admin') }}" method="post">
      ...
      <div class="control-group normal_text">
        <h3><img src="{{ asset('img/backend/logo.png')}}" alt="Logo" /></h3>
      </div>
      <div class="control-group">
        <div class="controls">
          <div class="main_input_box">
            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="email" name="email" placeholder="Email@example.com" />
          </div>
        </div>
      </div>
      <div class="control-group">
